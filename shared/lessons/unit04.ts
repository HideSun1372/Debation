...
export const UNIT_04_LESSONS: MultiPageLesson[] = [
  {
    ...
    pages: [
      ...
      },
      {
        type: "practice",
        id: "l04-01-p1",
        title: "Apply the 4 S's Framework",
        description: "Practice refuting an AI opponent's argument using the complete 4 S's framework.",
        practice: {
          type: "refutation",
          topic: "Standardized testing should be eliminated from college admissions",
          targetSkill: "Applying the 4 S's of Refutation (Signal, State, Support, Summarize)",
          instructions: "Your AI opponent will make an argument. Respond using all four S's: Signal what you're responding to, State their argument fairly, Support with your counter-argument, and Summarize why your response matters for the debate.",
          exampleResponse: "They said [X]. Their argument claims [Y]. But this fails because [Z]. Therefore, this argument doesn't support their position.",
          successCriteria: [
            "Signals clearly what argument is being addressed",
            "States the opponent's argument fairly and accurately",
            "Provides substantive support with reasoning or evidence",
            "Summarizes the impact—why this matters for the debate",
          ],
        },
      },
    ],
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        type: "practice",
        id: "l04-03-p1",
        title: "Direct Attack Practice",
        description: "Practice directly attacking an AI opponent's argument by targeting evidence, logic, or impact.",
        practice: {
          type: "refutation",
          topic: "Governments should mandate renewable energy usage",
          targetSkill: "Direct attack techniques: evidence attacks, logic attacks, and impact denial",
          instructions: "Your AI opponent will present an argument. Identify the weakest point and attack it directly. You can use evidence attacks (challenge source credibility, recency, methodology), logic attacks (expose flawed reasoning), or impact denial (argue even if true, it doesn't matter). Try to layer multiple attack types for maximum effect.",
          exampleResponse: "Use specific attacks: 'Their evidence is from [X] which is problematic because...' or 'Their logic fails because...' or 'Even if true, this doesn't matter because...'",
          successCriteria: [
            "Identifies a specific weakness in the opponent's argument",
            "Uses at least one clear attack type (evidence, logic, or impact)",
            "Explains why the attack undermines the argument",
            "Connects the attack to the broader debate outcome",
          ],
        },
      },
    ],
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        type: "practice",
        id: "l04-05-p1",
        title: "Classify the Claims",
        description: "Practice identifying whether claims are factual, value-based, or policy-based.",
        practice: {
          type: "claim-classifier",
          topic: "Environmental and economic policy debates",
          targetSkill: "Distinguishing between claims of fact, value, and policy",
          instructions: "You'll be presented with debate claims. For each claim, identify whether it's a claim of FACT (verifiable truth), VALUE (moral judgment), or POLICY (proposed action). Explain your reasoning and what type of proof would be needed.",
          exampleResponse: "This is a [fact/value/policy] claim because it [asserts verifiable truth / makes a moral judgment / proposes action]. To prove this, you would need [empirical evidence / ethical reasoning / cost-benefit analysis].",
          successCriteria: [
            "Correctly identifies the claim type (fact, value, or policy)",
            "Explains why the claim fits that category",
            "Identifies what type of proof would be needed",
            "Recognizes when claims might have elements of multiple types",
          ],
        },
      },
    ],
  },
  {
    ...
    pages: [
      ...
      },
      {
        type: "practice",
        id: "l04-06-p1",
        title: "Construct Strong Claims",
        description: "Practice building complete arguments with specific, defensible, and strategically framed claims.",
        practice: {
          type: "argument-builder",
          topic: "Artificial intelligence should be regulated by the government",
          targetSkill: "Constructing specific, provable, and strategically framed claims",
          instructions: "Build a complete argument with a strong claim. Your claim should be specific (include details like numbers, populations, timeframes), have appropriate scope (avoid universals like 'always' or 'never'), be provable with evidence, and be strategically framed for your position. Support your claim with evidence and reasoning.",
          exampleResponse: "Use the claim construction checklist: Is it specific? Is the scope appropriate? Can I prove it? Is it strategically framed?",
          successCriteria: [
            "Claim is specific with concrete details",
            "Scope is appropriate (avoids absolute language)",
            "Claim is supported with evidence or reasoning",
            "Framing anticipates potential attacks",
          ],
        },
      },
    ],
