    ...
    pages: [
      ...
      },
      {
        ...
        options: [
          ...
          { id: "c", text: "The first and last minute of each speech" },
          { id: "d", text: "There are no restrictions on POIs" },
        ],
        correctAnswer: "c",
      ...
      },
      {
        ...
        options: [
          { id: "a", text: "It doesn't allow Points of Information" },
          { id: "b", text: "It uses four teams of two debaters each" },
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        options: [
          { id: "a", text: "Bills are longer than resolutions" },
          { id: "b", text: "Bills create laws; resolutions express opinions" },
      ...
      },
      {
        ...
        options: [
          { id: "a", text: "The first person to raise their hand speaks" },
          { id: "b", text: "Priority goes to those who have spoken less" },
    ...
    pages: [
      ...
      },
      {
        ...
        options: [
          ...
          { id: "b", text: "Open-ended questions (who, what, when, where, why, how)" },
    ...
    pages: [
      ...
      },
      {
        ...
        options: [
          ...
          { id: "b", text: "Speaking at very rapid rates to present more arguments" },
          { id: "c", text: "Sharing evidence with your opponents" },
    ...
    pages: [
      ...
      },
      {
        ...
        options: [
          ...
          { id: "b", text: "A peer-reviewed clinical trial with large sample size" },
          { id: "c", text: "A single patient's positive experience" },
          { id: "d", text: "A newspaper opinion article" },
        ],
        correctAnswer: "b",
      ...
      },
      {
        ...
        options: [
          ...
          { id: "b", text: "Identifying which element (claim, evidence, or reasoning) is weakest and attacking it" },
          { id: "c", text: "Ignoring their argument completely" },
          { id: "d", text: "Reading more evidence without addressing their points" },
        ],
        correctAnswer: "b",
