...
export const UNIT_06_LESSONS: MultiPageLesson[] = [
  {
    ...
    pages: [
      ...
      },
      {
        ...
        id: "l06-01-p1",
        title: "Responding to Ad Hominem Attacks",
        description: "Practice responding professionally when an opponent uses an ad hominem attack against you.",
        practice: {
          type: "refutation",
          topic: "Social media companies should be held liable for user content",
          targetSkill: "Identifying and responding to ad hominem attacks while redirecting to substance",
          instructions: "Your AI opponent will attack you personally rather than your argument. Identify the type of ad hominem, briefly name the fallacy, and redirect the debate back to the substantive issue. Stay professional and don't attack back.",
          exampleResponse: "My opponent has attacked my motivations rather than my argument. Let me refocus on the actual issue: my evidence shows [X], and they haven't addressed why that evidence is wrong.",
          successCriteria: [
            "Correctly identifies the ad hominem attack",
            "Names the fallacy without being condescending",
            "Redirects to the substantive argument",
            "Maintains professional tone without retaliating",
          ],
        },
      },
    ],
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        type: "practice",
        id: "l06-04-p1",
        title: "Correcting Strawman Arguments",
        description: "Practice identifying when your argument has been strawmanned and effectively correcting the misrepresentation.",
        practice: {
          type: "refutation",
          topic: "Schools should have later start times for teenagers",
          targetSkill: "Recognizing strawman fallacies and redirecting to your actual argument",
          instructions: "Your AI opponent will misrepresent your position. Identify the strawman, clearly restate your actual argument, and explain why their characterization was inaccurate. Then continue with your substantive case.",
          exampleResponse: "My opponent has mischaracterized my position. I didn't say [strawman version]. What I actually argued was [correct version]. Let me be clear about my real claim and the evidence supporting it.",
          successCriteria: [
            "Identifies the specific misrepresentation",
            "Clearly restates the actual argument",
            "Explains why the strawman was inaccurate",
            "Returns to substantive engagement",
          ],
        },
      },
    ],
